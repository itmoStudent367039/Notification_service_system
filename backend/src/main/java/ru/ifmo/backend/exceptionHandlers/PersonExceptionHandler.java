package ru.ifmo.backend.exceptionHandlers;
...
import ru.ifmo.backend.util.PersonErrorResponse;
...
public class PersonExceptionHandler {
  ...
  private ResponseEntity<PersonErrorResponse> handleException(BadCredentialsException e) {
    var response =
        new PersonErrorResponse(
            Collections.singletonMap("error", e.getMessage()), System.currentTimeMillis());
  ...
  private ResponseEntity<PersonErrorResponse> handleException() {
    var response =
        new PersonErrorResponse(
            Collections.singletonMap("error", "id"), System.currentTimeMillis());
